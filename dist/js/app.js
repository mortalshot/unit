(() => {
    ...
    function initSliders() {
        if (document.querySelector(".template1__slider")) {
            const template1MainSlider = new core(".template1__slider", {
            ...
            const template1BgSlider = new core(".template1__bg-slider", {
            ...
            template1MainSlider.controller.control = template1BgSlider;
            template1BgSlider.controller.control = template1MainSlider;
        }
    }
    ...
    function gsapAnimations() {
        ...
        if (template4.length > 0) template4.forEach((element => {
            ...
            if (h1) template4Timeline.from(h1, {
                opacity: 0,
                duration: 1,
                ease: "power2.out"
            });
            const img = element.querySelector("img");
            if (img) template4Timeline.from(img, {
                yPercent: 30,
                duration: 1,
                ease: "power2.out"
            }, "-=1");
        ...
        if (template8Caption) gsap.from(template8Caption, {
            scrollTrigger: {
    ...
    if (menuItems.length > 0) menuItems.forEach((element => {
